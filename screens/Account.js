...
import { ActivityIndicator, StyleSheet, Text, View, TextInput, TouchableOpacity, Image } from 'react-native';
...
export default function Account({ navigation, route }) {
    ...
    const uploadPicture = (() => {
        camera.openGallery().then(image => {
            api.request('changeProfileImage', 'POST', { image: image }).then(response => {
        ...
        return (
            <View style={globalStyles.container_2}>
                <View style={{ alignItems: 'center' }}>
                    ...
                    >
                        <Text style={{ fontFamily: 'RobotoBold' }}>Change Profile Image</Text>
                    </TouchableOpacity>
                </View>
