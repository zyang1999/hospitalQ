...
export default function ICVerification({ navigation }) {
  ...
  return (
    <ScrollView style={globalStyles.container_2}>
      <Text>
        Please insert your personal information and verified yourself with your
        IC.
      </Text>
      ...
      {image ? (
        ...
        <View
          style={[
            globalStyles.image,
            { justifyContent: "center", backgroundColor: "#CCD1D1" },
          ]}
        >
      ...
      <SecondaryButton
        title={image ? "RETAKE IC PHOTO" : "TAKE IC PHOTO"}
        action={takePhoto}
      />
