                ...
                <View style={styles.modalContainer}>
                    <View>
                        <Text styles={globalStyles.h5}>
                            Please provide your reason to cancel the queue.
                        </Text>
                        <TextInput
                            multiline
                            numberOfLines={4}
        ...
        return (
            <View style={globalStyles.container_2}>
                ...
                <View style={[globalStyles.UserQueueBox, { flex: 0.6 }]}>
                    <Text style={globalStyles.h4}>
                        You haven't join a Queue Yet
                    </Text>
                    <PrimaryButton
                        title="JOIN QUEUE"
                        action={() => navigation.navigate("JoinQueue")}
                    />
                </View>
            </View>
        );
        ...
        return (
            <View style={[globalStyles.UserQueueBox]}>
                {userQueue.status == "SERVING" && (
                    <Text style={globalStyles.h2}>It's Your Turn!</Text>
                )}
